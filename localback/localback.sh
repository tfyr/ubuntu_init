nano ~/kirsa_nginxsudo apt install mysql-server nginx -y
...
scp telegram-0.1.6.tar.gz sunrise:~/
scp promocodes-0.1.1.tar.gz sunrise:~/

pip install ~/telegram-0.1.6.tar.gz 
pip install ~/promocodes-0.1.1.tar.gz
